    ...
    const fetchData = async () => {
      try {
        ...
        formik.setValues({
          ...
          username: school.data.user.username,
          password:school.data.user.password
        });
...
const validationSchema = Yup.object({
  username: Yup.string()
  .test('is-not-empty', 'Username cannot be empty', value => value !== undefined && value.trim() !== '')
    .min(3, 'Username must be at least 3 characters when provided'),
        ...
        <div className="flex flex-col lg:flex-row justify-center mt-6 gap-6">
          <div className="w-full lg:w-1/3 bg-gray-100 max-h-[300px] p-4 boxshadow">
            ...
            <img src={imageUrl} alt="Profile" 
                className="rounded-full mb-7 w-[150px] h-[150px] mt-[-10px]"
              />
