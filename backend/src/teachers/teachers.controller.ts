import { Controller, Post, UseGuards, Patch, Body ,Param, ParseIntPipe} from '@nestjs/common';
...
export class TeachersController {
    ...
    updateAdminTeacher(@GetUser('id') adminId:number, @Body() dto:UpdateAdminTeacherDto, @Param('id', ParseIntPipe) userId:number){
